...
- **(Engineering, non-blocking)** Higgsfield: does their public API expose a credits/balance endpoint? Investigate during Phase 5; fallback is the manual provider card.
