...
const VENDORS: Array<[RegExp, { domain: string; category: Category }]> = [
  ...
  [/three\.?js journey|bruno simon/i, { domain: "threejs-journey.com", category: "Learning" }],
  [/epic react|kent c\.? dodds/i, { domain: "epicreact.dev", category: "Learning" }],
  [/animations on the web|animations\.dev|kowalski/i, { domain: "animations.dev", category: "Learning" }],
